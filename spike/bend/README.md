...
| `LAWS.bend` / `PROOF.bend` | fifty-seven claims about the code, each proven | the test suite and Verus replay helpers |
...
Fifty-two mutations cover the primitive helpers, lost inserts, a lost trailing
...
that drops the words two lines share. The proof gate rejects
