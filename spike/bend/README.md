...
| `LAWS.bend` / `PROOF.bend` | two hundred and ninety-eight claims about the code, each proven | the test suite and Verus replay helpers |
...
Three hundred and seventy-one mutations cover the primitive helpers, lost inserts, a lost trailing
