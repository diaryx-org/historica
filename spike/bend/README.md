...
| `LAWS.bend` / `PROOF.bend` | eighty-five claims about the code, each proven | the test suite and Verus replay helpers |
...
Seventy-five mutations cover the primitive helpers, lost inserts, a lost trailing
...
folder-limit break: the folder's paths kept whatever the limit. The
proof gate rejects
