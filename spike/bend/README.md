...
| `LAWS.bend` / `PROOF.bend` | fifty-eight claims about the code, each proven | the test suite and Verus replay helpers |
...
Fifty-three mutations cover the primitive helpers, lost inserts, a lost trailing
...
takes a file without asking the rules. The proof gate rejects
