...
| `LAWS.bend` / `PROOF.bend` | a hundred and thirty-five claims about the code, each proven | the test suite and Verus replay helpers |
...
A hundred and thirty mutations cover the primitive helpers, lost inserts, a lost trailing
...
read; and one colour break: a marked line drawn without its sign; and two
...
unasked; and one span break: `a..b` read as `b..a`. The
proof gate rejects
