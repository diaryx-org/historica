...
| `LAWS.bend` / `PROOF.bend` | eighty-two claims about the code, each proven | the test suite and Verus replay helpers |
...
Seventy-three mutations cover the primitive helpers, lost inserts, a lost trailing
