...
| `LAWS.bend` / `PROOF.bend` | sixty-six claims about the code, each proven | the test suite and Verus replay helpers |
...
Sixty mutations cover the primitive helpers, lost inserts, a lost trailing
...
back as a file bookmark. The proof gate rejects
