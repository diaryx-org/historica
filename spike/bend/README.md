...
| `LAWS.bend` / `PROOF.bend` | seventy-seven claims about the code, each proven | the test suite and Verus replay helpers |
...
Seventy mutations cover the primitive helpers, lost inserts, a lost trailing
