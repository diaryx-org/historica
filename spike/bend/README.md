...
(`a_link_refers_only_to_what_the_revision_states`),
...
read; and ten survey breaks: a link to a file the record
drops let dangle, a link written as a reference where the revision states
nothing, a run of one path counted once too few, a file of lines refused
...
characters, and the clock compared with the earliest work. The
proof gate rejects
