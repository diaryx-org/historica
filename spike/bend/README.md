...
| `LAWS.bend` / `PROOF.bend` | sixty-eight claims about the code, each proven | the test suite and Verus replay helpers |
...
Sixty-one mutations cover the primitive helpers, lost inserts, a lost trailing
...
longest prefix it shares rather than one past it. The proof gate rejects
