...
| `LAWS.bend` / `PROOF.bend` | seventy-five claims about the code, each proven | the test suite and Verus replay helpers |
...
Sixty-eight mutations cover the primitive helpers, lost inserts, a lost trailing
...
ignored, and bytes the position never saw taken for text. The
proof gate rejects
