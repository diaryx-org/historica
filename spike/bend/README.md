...
| `LAWS.bend` / `PROOF.bend` | a hundred and seventy-nine claims about the code, each proven | the test suite and Verus replay helpers |
...
A hundred and sixty-nine mutations cover the primitive helpers, lost inserts, a lost trailing
...
and an `abandon` dry run naming the run in reverse; and one command-line
