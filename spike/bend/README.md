...
| | before | lazy | packed hash | sets | `historica` |
|---|---|---|---|---|---|
| `log` | 138 s | 15 s | 15 s | 5.5 s | 0.01 s |
| `files head` | 140 s | 20 s | 0.03 s | 0.03 s | 0.02 s |
| `cat head Resume.md` | 205 s | 29 s | 0.03 s | 0.03 s | 0.02 s |
| `show <revision>` | 143 s | 2.8 s | 0.03 s | 0.03 s | 0.00 s |
| `check` | 146 s | 11 s | 6 s | 5.3 s | 0.87 s |
...
reading `revisions/` a second time. What is left is Bend's own decoding and
