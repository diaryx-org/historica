...
| `LAWS.bend` / `PROOF.bend` | seventy-one claims about the code, each proven | the test suite and Verus replay helpers |
...
Sixty-four mutations cover the primitive helpers, lost inserts, a lost trailing
...
the marker after a line without a newline left out. The
proof gate rejects
