...
| `LAWS.bend` / `PROOF.bend` | a hundred and eighty-three claims about the code, each proven | the test suite and Verus replay helpers |
...
and an `abandon` dry run naming the run in reverse; and three update
...
payload laid over work nobody recorded. The
proof gate rejects
