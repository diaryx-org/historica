...
| `LAWS.bend` / `PROOF.bend` | fifty-nine claims about the code, each proven | the test suite and Verus replay helpers |
...
Fifty-four mutations cover the primitive helpers, lost inserts, a lost trailing
...
revision taken without asking the store. The proof gate rejects
