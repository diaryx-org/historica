...
| `LAWS.bend` / `PROOF.bend` | eighty-three claims about the code, each proven | the test suite and Verus replay helpers |
...
Seventy-four mutations cover the primitive helpers, lost inserts, a lost trailing
...
file it names; and one shown-file break: a file shown whose sides agree.
The
proof gate rejects
