...
| `LAWS.bend` / `PROOF.bend` | eighty-six claims about the code, each proven | the test suite and Verus replay helpers |
...
Seventy-six mutations cover the primitive helpers, lost inserts, a lost trailing
...
log-argument break: `--author` read as `--grep`. The
proof gate rejects
