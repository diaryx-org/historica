...
| `LAWS.bend` / `PROOF.bend` | two hundred and seventy-three claims about the code, each proven | the test suite and Verus replay helpers |
...
fourteen `skip` breaks: rule equality blind to privacy, a directory's rule
