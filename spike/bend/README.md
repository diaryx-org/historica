...
| `LAWS.bend` / `PROOF.bend` | seventy-six claims about the code, each proven | the test suite and Verus replay helpers |
...
Sixty-nine mutations cover the primitive helpers, lost inserts, a lost trailing
