...
| `LAWS.bend` / `PROOF.bend` | a hundred and sixty-two claims about the code, each proven | the test suite and Verus replay helpers |
...
unasked; and one span break: `a..b` read as `b..a`; and six normal-form
