...
| `LAWS.bend` / `PROOF.bend` | two hundred and sixty-eight claims about the code, each proven | the test suite and Verus replay helpers |
...
Two hundred and ninety-four mutations cover the primitive helpers, lost inserts, a lost trailing
...
rules written before the last; and eight breaks of reading what the host
