...
| `LAWS.bend` / `PROOF.bend` | eighty-eight claims about the code, each proven | the test suite and Verus replay helpers |
...
Seventy-eight mutations cover the primitive helpers, lost inserts, a lost trailing
