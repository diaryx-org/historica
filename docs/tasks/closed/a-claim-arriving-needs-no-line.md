...
[0074](/docs/decisions/0074-saying-where-to-look.md)'s vocabulary is four line
...
under [0053](/docs/decisions/0053-room-for-another-tool.md) and
...
- **Enforcement inside receive.** Refusing unvouched history at the door is
  deferred by [0046](/docs/decisions/0046-who-vouches-for-a-revision.md) to a
...
- **`RESERVED_DIRS` as a caller-supplied value.** Also 0053's need-first trait.
  ...
  [0056](/docs/decisions/0056-listing-what-it-cannot-read.md) makes the receiver's
  ...
  under [0045](/docs/decisions/0045-one-rule-to-a-file.md)'s rule.
